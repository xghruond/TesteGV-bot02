...
App.formFields = [
  ...
  { id: 'telefone', label: 'Telefone para SMS (com DDD)', type: 'tel', placeholder: '(11) 99999-9999', required: true, icon: 'phone', helpText: 'Selecione um número Twilio clicando acima. Será usado para enviar credenciais por SMS.' },

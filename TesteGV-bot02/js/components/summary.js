    ...
    '<div>' +
      ...
      '<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 no-print">' +
        ...
        '<button data-action="copy-summary" aria-label="Copiar resumo para área de transferência" class="flex items-center justify-center gap-2 rounded-xl border border-dark-600/50 px-5 py-3 text-sm font-medium text-dark-300 transition-colors hover:bg-dark-700/50 hover:text-brand-400 hover:border-brand-500/30">' +
          App.icons.copy + ' Resumo</button>' +
        '<button data-action="copy-as-table" aria-label="Copiar como tabela (Excel)" class="flex items-center justify-center gap-2 rounded-xl border border-brand-500/30 bg-brand-500/5 px-5 py-3 text-sm font-medium text-brand-400 transition-colors hover:bg-brand-500/10 hover:border-brand-500/50">' +
          App.icons.copy + ' Tabela (Excel)</button>' +
        '<button data-action="export-pdf" aria-label="Exportar resumo como PDF" class="flex items-center justify-center gap-2 rounded-xl border border-dark-600/50 px-5 py-3 text-sm font-medium text-dark-300 transition-colors hover:bg-dark-700/50 hover:text-brand-400 hover:border-brand-500/30">' +
          App.icons.download + ' PDF</button>' +
        '<button data-action="reset" aria-label="Iniciar novo onboarding" class="sm:col-span-2 lg:col-span-4 flex items-center justify-center gap-2 btn-futuristic rounded-xl px-6 py-3.5 text-base font-semibold text-white">' +
